    ...
    <div className="events">
      ...
      <h1 className="next-event">Next Event</h1>
        {currentEvents.map((event, index) => (
          <div
            key={index}
            className={`event-card ${index === 0 ? "full-width" : "half-width"}`}
          >
            {index === 0 ? (
              <div className="full-width-layout">
                ...
                <Countdown
                  ...
                  renderer={({ days, hours, minutes, seconds, completed }) => {
                    if (completed) {
                      return <div className="flip-countdown completed">Event has completed</div>;
                    }
                    return (
                      <div className="flip-countdown">
                        <FlipUnit value={days} label="Days" /> <p className="countdown-colon">:</p>
                        <FlipUnit value={hours} label="Hours" /> <p className="countdown-colon">:</p>
                        <FlipUnit value={minutes} label="Minutes" /> <p className="countdown-colon">:</p>
      ...
      <div className="event-subscribe">
        ...
        <p className="subscribe-text">Subscribe to never miss out on any events.</p>
        <div className="subscribe-box">
          <input type="email" placeholder="Enter your email here" className="subscribe-input" />
      ...
      <div className="events-pagination">
        ...
        {Array.from({ length: totalPages }, (_, i) => (
          <button
            ...
            className={`events-page-button ${currentPage === i + 1 ? "active" : ""}`}
          >
            {i + 1}
          </button>
        ))}
